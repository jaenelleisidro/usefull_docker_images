...
//rebuild anonymous volume, usefull when you added new library in node modules which is ussually in anonymous volume
docker-compose -f docker-compose.yml -f docker-compose.dev.yml up -d --build -V

//rebuild node-app image and its dependencies
docker-compose -f docker-compose.yml -f docker-compose.dev.yml up -d --build --no-deps node-app

//rebuild node-app image and avoid any dependencies from getting rebuilt
docker-compose -f docker-compose.yml -f docker-compose.dev.yml up -d --build --no-deps node-app

//rebuild node-app image even if there's no changes exclude dependencies
docker-compose -f docker-compose.yml -f docker-compose.dev.yml up -d --force-recreate --no-deps node-app
...
//for scaled
docker logs node-app_1 -f
docker logs node-app_2 -f
